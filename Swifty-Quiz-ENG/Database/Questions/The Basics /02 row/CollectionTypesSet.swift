	...
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: ["If an array or dictionary is assigned to a variable, can we modify it?",
					 ...
					 image: "",
					 optionA: "Yes",
					 optionB: "Only adding elements",
					 optionC: "Only removing elements",
					 optionD: "No",
					 questionId: 307,
			...
			Question(question: ["What type will this ints array have and what will be inside?",
								"Choose an answer with the correct type and content of the ints collection",
								"Select the type and content this ints array will have"],
					 image: "Collections15",
			...
			/// 332 - Самописный хелп (Кроме последней строки, она из https://developer.apple.com/documentation/swift/string/2893517-droplast)
			
			Question(question: ["How can we remove one or more of the last elements of an array and return the remaining array?",
								"Which method will help you remove the last few values of the array, and return what's left?",
								"Choose a method that allows you to remove the last few elements of the array and return the rest"],
					 image: "",
					 optionA: ".dropLast()",
					 optionB: ".removeLast()",
					 optionC: ".remove(_ :at:)",
			...
			Question(question: ["What kind of types can we store in a set?",
								"The type of the values must be exactly that to be able to be stored in the set"],
					 image: "",
					 optionA: "Hashable",
					 optionB: "Boolean",
					 optionC: "Numerical",
			...
			Question(question: ["If you try to remove an element of a set that is not in it, what will happen?",
					 ...
					 image: "",
					 optionA: "nil",
					 optionB: "Last element of the Set",
					 optionC: "First element of the Set",
			...
			Question(question: ["Which method we need to use to determine whether all of the values of a set are contained in the specified set?"],
					 image: "",
					 optionA: "isSubset(of:)",
