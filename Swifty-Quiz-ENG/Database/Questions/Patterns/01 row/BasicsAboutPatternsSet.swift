...
class BasicsAboutPatternsSet {
	static func getQuestions() -> [Question] {
		return [
			Question(question: ["Which of these best describes a design pattern?"],
					 image: "",
			...
			Question(question: ["Can we just find a pattern and copy it into our program to solve a problem?",
								"You can just copy a pattern into your program as a solution to your problem. Is that true?"],
					 image: "",
					 optionA: "No",
					 optionB: "Yes",
					 optionC: "",
			...
			Question(question: ["Are design patterns and algorithms the same?"],
					 image: "",
					 optionA: "No",
					 optionB: "Yes",
					 optionC: "",
			...
			Question(question: ["What is the basis of Creational Patterns?"],
					 image: "",
					 optionA: "Object creation",
					 optionB: "Classes and object composition",
					 optionC: "Inheritance of classes",
					 optionD: "",
					 questionId: 2506,
			...
			Question(question: ["Structural patterns explain how to..."],
					 image: "",
					 optionA: "Organize objects",
					 optionB: "Create efficient objects",
					 optionC: "Keep structures flexible",
					 optionD: "",
					 questionId: 2508,
			...
			Question(question: ["Can design patterns speed up the development process?",
								"Does effective software design require considering issues that may not become visible until later in the implementation?",
								"Can design patterns help to prevent hidden subtle issues and improve code readability?"],
					 image: "",
					 optionA: "Yes",
					 optionB: "No",
					 optionC: "",
			...
			Question(question: ["The design pattern that provides an interface for creating families of related or dependent objects without specifying their concrete classes"],
					 image: "",
			...
			Question(question: ["The design pattern that converts the interface of a class into another interface clients expect",
								"Choose the design pattern that lets classes work together that could not be implemented otherwise because of incompatible interfaces"],
					 image: "",
					 optionA: "Adapter",
					 optionB: "Bridge",
					 optionC: "Composite",
			...
			Question(question: ["The main purpose of which design pattern is coupling the sender of a request to its receiver by giving more than one object a chance to handle the request?"],
					 image: "",
			...
			Question(question: ["The pattern that decouples an abstraction from its implementation allowing the two to vary independently"],
					 image: "",
					 optionA: "Bridge",
					 optionB: "Composite",
					 optionC: "Decorator",
			...
			Question(question: ["Which design pattern defines an interface for creating a single object, but let subclasses decide which class to instantiate?",
								"Which pattern defines an interface for creating a single object and lets a class defer instantiation to subclasses?"],
					 image: "",
			...
			Question(question: ["The purpose of this pattern is to compose objects into tree structures to represent part-whole hierarchies",
					 ...
					 optionD: "Facade",
					 questionId: 2517,
					 helpText: "The composite pattern describes a group of objects that are treated the same way as a single instance of the same type of object. The intent of a composite is to \"compose\" objects into tree structures to represent part-whole hierarchies. Implementing the composite pattern lets clients treat individual objects and compositions uniformly. The Composite design pattern is one of the twenty-three well-known Gang of Four design patterns that describe how to solve recurring design problems to design flexible and reusable object-oriented software, that is, objects that are easier to implement, change, test, and reuse."),
			
			Question(question: ["Which of the following patterns provides a way to access the elements of an aggregate object sequentially without exposing its underlying representation"],
					 image: "",
					 optionA: "Iterator",
					 optionB: "Mediator",
					 optionC: "Memento",
			...
			Question(question: ["This pattern specifies the kinds of objects to create using a model instance, and create new objects from the 'skeleton' of an existing object"],
					 image: "",
					 optionA: "Prototype",
					 optionB: "Singleton",
					 optionC: "Factory method",
			...
			Question(question: ["Pick the design pattern that attaches additional responsibilities to an object dynamically keeping the same interface",
								"A crucial design pattern that provides a flexible alternative to subclassing for extending functionality"],
					 image: "",
					 optionA: "Decorator",
					 optionB: "Composite",
					 optionC: "Facade",
			...
			Question(question: ["Choose the pattern that defines an object that encapsulates how a set of objects interact",
			...
			Question(question: ["From the options below, pick the pattern that ensures a class has only one instance, and provides a global point of access to it"],
					 image: "",
					 optionA: "Singleton",
					 optionB: "Proxy",
					 optionC: "Flyweight",
			...
			Question(question: ["Which of these patterns provides a unified interface to a set of interfaces in a subsystem",
								"The pattern that defines a higher-level interface that makes the subsystem easier to use"],
					 image: "",
					 optionA: "Facade",
					 optionB: "Flyweight",
					 optionC: "Proxy",
					 optionD: "Memento",
					 questionId: 2523,
					 helpText: "The facade pattern is a software-design pattern commonly used in object-oriented programming. Analogous to a facade in architecture, a facade is an object that serves as a front-facing interface masking more complex underlying or structural code. A facade can: improve the readability and usability of a software library by masking interaction with more complex components behind a single (and often simplified) API, provide a context-specific interface to more generic functionality, serve as a launching point for a broader refactor of monolithic or tightly-coupled systems in favor of more loosely-coupled code. Developers often use the facade design pattern when a system is very complex or difficult to understand because the system has many interdependent classes or because its source code is unavailable."),
			
			Question(question: ["The pattern that allows capturing and externalizing an object's internal state allowing the object to be restored to this state later without violating encapsulation"],
					 image: "",
					 optionA: "Memento",
					 optionB: "State",
					 optionC: "Strategy",
			...
			Question(question: ["The ... pattern defines a one-to-many dependency between objects where a state change in one object results in all its dependents being notified and updated automatically"],
					 image: "",
					 optionA: "Observer",
					 optionB: "Visitor",
					 optionC: "Facade",
			...
			Question(question: ["The ... pattern allows an object to alter its behavior when its internal state changes, the object will appear to change its class"],
					 image: "",
					 optionA: "State",
					 optionB: "Strategy",
			...
			Question(question: ["The pattern that defines a family of algorithms, encapsulate each one, and make them interchangeable",
								"You can use it to define a family of algorithms, encapsulate each one, and make them interchangeable and then let the algorithm vary independently from clients that use it"],
					 image: "",
					 optionA: "Strategy",
			...
			Question(question: ["Choose the pattern that defines the skeleton of an algorithm in an operation, deferring some steps to subclasses",
			...
			Question(question: ["This pattern represents an operation to be performed on the elements of an object structure and lets a new operation be defined without changing the classes of the elements on which it operates"],
					 image: "",
					 optionA: "Visitor",
					 optionB: "Mediator",
					 optionC: "Facade",
