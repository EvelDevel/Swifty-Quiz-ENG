...
class AntipatternsSet {
	static func getQuestions() -> [Question] {
		return [
			Question(question: ["The anti-pattern that has a relation between two or more modules which either directly or indirectly depend on each other to function properly"],
					 image: "",
			...
			Question(question: ["Which anti-pattern has an entity that knows too much or does too much?"],
					 image: "",
					 optionA: "God object",
			...
			Question(question: ["The anti-pattern in which behavior in one part of a program varies because it’s difficult to identify operations in another part of the program"],
					 image: "",
					 ...
					 optionD: "",
					 questionId: 2903,
					 helpText: "Action at a distance is an anti-pattern (an obfuscation technique) in computer science in which behavior in one part of a program varies wildly based on how difficult or impossible it is to identify operations in another part of the program. The way to avoid the problems associated with action at a distance are a proper design, which avoids global variables and alters data only in a controlled and local manner, or usage of a pure functional programming style with referential transparency."),
			
			Question(question: ["The anti-pattern in which programmer keep maintaining the obsolete code \"just in case\"?"],
					 image: "",
					 optionA: "Boat anchor",
			...
			Question(question: ["Which anti-pattern describes the practice of catching an exception, and then continuing without logging, processing, or reporting it?"],
					 image: "",
			...
			Question(question: ["This anti-pattern includes embedding data directly into the source code of a program or other executable object, as opposed to obtaining the data from external sources or generating it at runtime"],
					 image: "",
					 optionA: "Hard code",
					 optionB: "Soft code",
					 optionC: "Magic numbers",
			...
			Question(question: ["Where the objects within the program rely on a single object for most of their information and interaction?"],
					 image: "",
					 optionA: "God object",
					 optionB: "Hard Code",
					 optionC: "Boat anchor",
					 optionD: "",
					 questionId: 2907,
					 helpText: "Because the God object holds so much data and requires so many methods, its role in the program becomes God-like (all-knowing and all-encompassing). Instead of program objects communicating among themselves directly, the other objects within the program rely on the single God object for most of their information and interaction. Since this object is tightly coupled to so much of the other code, maintenance becomes more difficult than it would be in a more evenly divided programming design. Changes made to the object for the benefit of one routine can have unintended effects on other unrelated routines."),
			
			Question(question: ["The anti-pattern that refers to code whose layers are so complicated and intertwined that making a change in one layer would necessitate changes in all other layers"],
					 image: "",
			...
			Question(question: ["This anti-pattern refers to a problem in which computer code written under suboptimal conditions is put into production and added to while still in a developmental state"],
					 image: "",
					 optionA: "Lava flow",
			...
			Question(question: ["The possible problems of which anti-pattern include longer compile times and the risk that programmers may accidentally link working code into the defunct code, inadvertently resurrecting it?"],
					 image: "",
					 optionA: "Boat anchor",
					 optionB: "Accidental complexity",
					 optionC: "Coding by exception",
			...
			Question(question: ["This principle of software development aimed at optimizing the use of software patterns, replacing the same code with abstractions or using data normalization to avoid redundancy"],
					 image: "",
